...
CREATE TABLE Products (
    ...
    date_entry DATE,
    product_description LONGTEXT DEFAULT 'Sin descripción',
...
ON UPDATE CASCADE 
ON DELETE CASCADE;
ALTER TABLE ProductEspecification DROP CONSTRAINT FK_product;
...
-- Product to Prodcuct Status
ALTER TABLE Products ADD CONSTRAINT FK__productStatus
